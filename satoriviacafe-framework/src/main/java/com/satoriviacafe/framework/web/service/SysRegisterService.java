...
import com.satoriviacafe.common.exception.user.CaptchaException;
import com.satoriviacafe.common.exception.user.CaptchaExpireException;
...
public class SysRegisterService {
    ...
    public String register(RegisterBody registerBody) {
        ...
        if (VStringUtils.isEmpty(username)) {
            msg = "用户名不能为空";
        } else if (VStringUtils.isEmpty(password)) {
            msg = "用户密码不能为空";
            ...
            if (!regFlag) {
                ...
                asyncManager.executeDelay(AsyncFactory.recordLogininfor(username, Constants.REGISTER, MessageUtils.message("user.register.success")));
            }
        }
        return msg;
    }
