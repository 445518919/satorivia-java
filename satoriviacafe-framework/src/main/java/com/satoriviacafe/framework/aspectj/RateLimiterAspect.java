...
import com.satoriviacafe.common.annotation.RateLimiter;
import com.satoriviacafe.common.enums.LimitType;
...
public class RateLimiterAspect {
    ...
    public void doBefore(JoinPoint point, RateLimiter rateLimiter) throws Throwable {
        ...
        try {
            ...
            if (VStringUtils.isNull(number) || number.intValue() > count) {
