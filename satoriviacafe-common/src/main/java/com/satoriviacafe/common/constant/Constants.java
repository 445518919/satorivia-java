...
public class Constants
{
     ...
     */
    public static final String[] JSON_WHITELIST_STR = { "org.springframework", "com.satoriviacafe" };

    /**
     * 定时任务白名单配置（仅允许访问的包名，如其他需要可以自行添加）
     */
    public static final String[] JOB_WHITELIST_STR = {"com.satoriviacafe.quartz.task", "com.satoriviacafe.valorant.task","com.satoriviacafe.community.task"};

    /**
     * 定时任务违规的字符
     */
    public static final String[] JOB_ERROR_STR = {"java.net.URL", "jakarta.naming.InitialContext", "org.yaml.snakeyaml",
            "org.springframework", "org.apache", "com.satoriviacafe.common.utils.file", "com.satoriviacafe.common.config", "com.satoriviacafe.generator" };
}
