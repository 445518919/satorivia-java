...
public class FileUtils {
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, SatoriviacafeConfig.getImportPath());
    }
    ...
    public static boolean checkAllowDownload(String resource) {
        // 禁止目录上跳级别
        if (VStringUtils.contains(resource, "..")) {
            return false;
        }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/satoriviacafe.png -- satoriviacafe.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/satoriviacafe.png -- satoriviacafe
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
