package com.satoriviacafe.common.utils.http;
 ...
 */
@SuppressWarnings({"unused", "LoggingSimilarMessage", "DuplicatedCode"})
public class HttpUtils {
    ...
    public static String sendGet(String url) {
        return sendGet(url, VStringUtils.EMPTY);
    }
    ...
    public static String sendGet(String url, String param, String contentType) {
        ...
        try {
            String urlNameString = VStringUtils.isNotBlank(param) ? url + "?" + param : url;
    ...
    public static String sendSSLPost(String url, String param, String contentType) {
        ...
        try {
            ...
            HttpsURLConnection conn = getHttpsURLConnection(contentType, console, sc);
    ...
    @NotNull
    private static HttpsURLConnection getHttpsURLConnection(String contentType, URL console, SSLContext sc) throws IOException {
