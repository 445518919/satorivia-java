package com.satoriviacafe.common.core.controller;
...
public class BaseController {
    ...
    protected void startOrderBy() {
        ...
        if (VStringUtils.isNotEmpty(pageDomain.getOrderBy())) {
    ...
    protected <T> RT<T> getRT(List<T> list) {
        RT<T> rspData = new RT<>();
        rspData.setCode(HttpStatus.SUCCESS);
        rspData.setMsg("查询成功");
        rspData.setRows(list);
    ...
    public String redirect(String url) {
        return VStringUtils.format("redirect:{}", url);
    }
