package com.satoriviacafe.common.core.text;
...
public class Convert {
    ...
    public static Character toChar(Object value, Character defaultValue) {
        ...
        return VStringUtils.isEmpty(valueStr) ? defaultValue : valueStr.charAt(0);
    }
    ...
    public static Byte toByte(Object value, Byte defaultValue) {
        ...
        final String valueStr = toStr(value, null);
        if (VStringUtils.isEmpty(valueStr)) {
            return defaultValue;
        }
        try {
    ...
    public static String str(byte[] bytes, String charset) {
        return str(bytes, VStringUtils.isEmpty(charset) ? Charset.defaultCharset() : Charset.forName(charset));
    }
