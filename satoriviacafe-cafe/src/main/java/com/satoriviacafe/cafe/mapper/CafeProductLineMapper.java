 ...
 * @since 2026-06-28
 */
public interface CafeProductLineMapper {
    /**
     * 查询咖啡产品线
     *
     ...
     * @return 结果
     */
    int insertBatchCafeProductLine(List<CafeProductLine> cafeProductLines);
     ...
     * @return 结果
     */
    int insertBatchIgnoreCafeProductLine(List<CafeProductLine> cafeProductLines);
