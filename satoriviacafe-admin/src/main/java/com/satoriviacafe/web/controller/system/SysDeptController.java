...
public class SysDeptController extends BaseController
{
    ...
    public AjaxResult excludeChild(@PathVariable(value = "deptId", required = false) Long deptId)
    {
        ...
        depts.removeIf(d -> d.getDeptId().intValue() == deptId || ArrayUtils.contains(VStringUtils.split(d.getAncestors(), ","), deptId + ""));
        return success(depts);
    }
    ...
    public AjaxResult edit(@Validated @RequestBody SysDept dept)
    {
        ...
        else if (VStringUtils.equals(UserConstants.DEPT_DISABLE, dept.getStatus()) && deptService.selectNormalChildrenDeptById(deptId) > 0)
        {
