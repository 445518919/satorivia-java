...
import com.satoriviacafe.system.domain.SysCache;
...
public class CacheController {
    ...
    static {
        ...
        caches.add(new SysCache(CacheConstants.REFRESH_TOKEN_KEY, "刷新令牌"));
        caches.add(new SysCache(CacheConstants.VALORANT_SKIN_ONE_KEY, "瓦洛蘭特皮膚"));
        caches.add(new SysCache(CacheConstants.VALORANT_SKIN_LIST_KEY, "瓦洛蘭特皮膚列表"));
        caches.add(new SysCache(CacheConstants.VALORANT_SKIN_ALL_RATING_KEY, "瓦洛蘭特皮膚評分"));
        caches.add(new SysCache(CacheConstants.EMAIL_CODE, "郵箱驗證碼"));
    }
    ...
    public AjaxResult getInfo() throws Exception {
        ...
        if(commandStats == null){
            throw new Exception("Redis服務異常，請檢查Redis服務");
        }
        ...
        commandStats.stringPropertyNames().forEach(key -> {
            ...
            data.put("name", VStringUtils.removeStart(key, "cmdstat_"));
            data.put("value", VStringUtils.substringBetween(property, "calls=", ",usec"));
            pieList.add(data);
        });
