...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('产品NFC', '1100', '1', 'nfc', 'cafe/nfc/index', 1, 0, 'C', '0', '0', 'cafe:nfc:list', '#', 'admin', sysdate(),
        '', null, '产品NFC菜单');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('产品NFC查询', @parentId, '1', '#', '', 1, 0, 'F', '0', '0', 'cafe:nfc:query', '#', 'admin', sysdate(), '',
        null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('产品NFC新增', @parentId, '2', '#', '', 1, 0, 'F', '0', '0', 'cafe:nfc:add', '#', 'admin', sysdate(), '', null,
        '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('产品NFC修改', @parentId, '3', '#', '', 1, 0, 'F', '0', '0', 'cafe:nfc:edit', '#', 'admin', sysdate(), '', null,
        '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('产品NFC删除', @parentId, '4', '#', '', 1, 0, 'F', '0', '0', 'cafe:nfc:remove', '#', 'admin', sysdate(), '',
        null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('产品NFC导出', @parentId, '5', '#', '', 1, 0, 'F', '0', '0', 'cafe:nfc:export', '#', 'admin', sysdate(), '',
        null, '');
